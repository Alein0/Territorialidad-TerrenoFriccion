...
public class Predator : MonoBehaviour
{
    ...
    {
        Collider2D[] hits = Physics2D.OverlapCircleAll(transform.position, visionRange, LayerMask.GetMask("Bunnies")); // Busca todos los collider dentro del rango de visi�n
